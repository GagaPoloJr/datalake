      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>Buletin Data Lake</h1>
          </div>
          <div class="section-body">
            <h2 class="section-title">Buletin Data Lake BEM UNDIP</h2>
          ...
          <div class="col-lg-12 col-md-12 col-12 col-sm-12">
            <div class="card">
              <div class="card-header">
                <h4>Buletin terakhir</h4>
              </div>
              <div class="card-body">
                
                <?php $this->load->view('Admin/_partial/alert_data') ?>

                <a href="<?php echo base_url() . 'buletin' ?>" class="btn btn-lg icon-left btn-primary"><i class="far fa-edit"></i> Tambah Buletin </a>
                ...
                <table style="width: 100%;" id="table-artikel" class="table table-bordered table-striped">
                  ...
                  <div>
                    <tbody class="belang">
                      <?php $i = 1 ?>
                      <?php $hitung = $this->db->from('buletin')->count_all_results(); ?>
                      <?php foreach ($buletin as $tampil) { ?>
                        ...
                        <tr>
                          ...
                          <?php if($hitung > 1){ ?>
                            <?php if ($tampil->status == "no") { ?>
                              <a onclick="konfirmasi('<?php echo base_url() . 'Buletin/konfirmasi_buletin/' . $tampil->id ?>')" href="#konfirmasidata" class="btn btn-icon icon-left btn-success" data-toggle="tooltip" data-placement="top" title="Konfirmasi"><i class="fas fa-check"></i></a>
                              ...
                              <a onclick="hapus('<?php echo base_url() . 'Buletin/delete_buletin/' . $tampil->id ?>')" href="#!" class="btn btn-icon icon-left btn-danger" data-toggle="tooltip" data-placement="top" title="Hapus"><i class="fas fa-times"></i></a>
                            ...
                            <?php } else { ?>
                              ...
                              <a href="<?php echo base_url() . 'Buletin/hide_buletin/' . $tampil->id ?>" class="btn btn-icon icon-left btn-warning" data-toggle="tooltip" data-placement="top" title="Sembunyikan"><i class="far fa-user"></i></a>

                            <?php } ?>
                            <a href="<?php echo base_url() . 'Buletin/halaman_edit/' . $tampil->id ?>" class="btn btn-icon icon-left btn-primary" data-toggle="tooltip" data-placement="top" title="Edit"><i class="far fa-edit"></i></a>
