			...
			<div class="main-content">
				<section class="section">
					...
					<div class="section-body">
						<h2 class="section-title">Halaman Edit Artikel</h2>
						<p class="section-lead">Silahkan mengedit artikel yang diinginkan.</p>

						<div class="row">
							<div class="col-12">
								<form action="<?php echo site_url('artikel/edit'); ?>" method="post" enctype="multipart/form-data">
									<div class="card">
  ...
  <script src="<?php echo base_url() . 'assets/modules/summernote/summernote-bs4.js' ?>"></script>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			var data = '<?php foreach($artikel as $a) {echo $a->content;} ?>'
