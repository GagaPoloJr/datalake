			...
			<div class="main-content">
				<section class="section">
					...
					<div class="section-body">
						<h2 class="section-title">Halaman Edit Admin</h2>
						<p class="section-lead">Silahkan mengedit Admin Staff</p>
							...
							<div class="col-12">
								<form action="<?php echo site_url('User/edit'); ?>" method="post"enctype="multipart/form-data">
									<div class="card">
										...
										<div class="card-body">
										<input type="hidden" class="form-control" name="user_id" value="<?php echo $a->user_id; ?>">
                                            ...
                                            <div class="form-group row mb-4">
												...
												<div class="col-sm-12 col-md-7">
													<input type="text" class="form-control" name="user_name" value="<?php echo $a->user_name ?>">
												</div>
                                            </div>
                                            <div class="form-group row mb-4">
												<label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Password</label>
												<div class="col-sm-12 col-md-7">
													<input type="text" class="form-control" name="user_password" value="<?php echo $a->user_password ?>">
												</div>
											</div>
										</div>
										<?php }?>
