			...
			<div class="main-content">
				<section class="section">
					...
					<div class="section-body">
						<h2 class="section-title">Halaman Tambah Kategori</h2>
						<p class="section-lead">Silahkan menambah Kategori yang diinginkan untuk artikel</p>

						<div class="row">
							<div class="col-12">
								<form action="<?php echo site_url('Kategori/save'); ?>" method="post"enctype="multipart/form-data">
									<div class="card">
