			...
			<div class="main-content">
				<section class="section">
					...
					<div class="section-body">
						<h2 class="section-title">Halaman Tambah Buletin</h2>
						<p class="section-lead">Silahkan menambah buletin, semangat~</p>

						<div class="row">
							<div class="col-12">
								<form action="<?php echo site_url('Buletin/save'); ?>" method="post"enctype="multipart/form-data">
									<div class="card">
